...
struct futhark_opaque_98d86a09 ;
int futhark_free_opaque_98d86a09(struct futhark_context *ctx,
                                 struct futhark_opaque_98d86a09 *obj);
struct futhark_opaque_f51e26b8 ;
int futhark_free_opaque_f51e26b8(struct futhark_context *ctx,
                                 struct futhark_opaque_f51e26b8 *obj);
...
int futhark_entry_finalize(struct futhark_context *ctx,
                           ...
                           struct futhark_opaque_98d86a09 *in0);
...
int futhark_entry_add_columns(struct futhark_context *ctx,
                              struct futhark_opaque_98d86a09 **out0, const
                              struct futhark_opaque_98d86a09 *in0, const
...
int futhark_entry_hash2(struct futhark_context *ctx,
                        ...
                        struct futhark_opaque_f51e26b8 *in0, const
...
int futhark_entry_init2(struct futhark_context *ctx,
                        struct futhark_opaque_f51e26b8 **out0, const
                        struct futhark_u64_1d *in0, const
                        struct futhark_u64_2d *in1, const
                        struct futhark_u64_3d *in2, const
                        struct futhark_u64_3d *in3, const
