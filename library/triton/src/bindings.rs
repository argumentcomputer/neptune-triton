...
pub const CL_TARGET_OPENCL_VERSION: u32 = 220;
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct futhark_opaque_98d86a09 {
    _unused: [u8; 0],
}
extern "C" {
    pub fn futhark_free_opaque_98d86a09(
        ctx: *mut futhark_context,
        obj: *mut futhark_opaque_98d86a09,
    ) -> ::std::os::raw::c_int;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct futhark_opaque_f51e26b8 {
    _unused: [u8; 0],
}
extern "C" {
    pub fn futhark_free_opaque_f51e26b8(
        ctx: *mut futhark_context,
        obj: *mut futhark_opaque_f51e26b8,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn futhark_entry_finalize(
        ...
        in0: *const futhark_opaque_98d86a09,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn futhark_entry_simple11(
        ctx: *mut futhark_context,
        out0: *mut *mut futhark_u64_2d,
        in0: i32,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    pub fn futhark_entry_add_columns(
        ctx: *mut futhark_context,
        out0: *mut *mut futhark_opaque_98d86a09,
        in0: *const futhark_opaque_98d86a09,
        in1: i32,
...
extern "C" {
    pub fn futhark_entry_hash2(
        ...
        in0: *const futhark_opaque_f51e26b8,
...
extern "C" {
    pub fn futhark_entry_init2(
        ctx: *mut futhark_context,
        out0: *mut *mut futhark_opaque_f51e26b8,
        in0: *const futhark_u64_1d,
        in1: *const futhark_u64_2d,
        in2: *const futhark_u64_3d,
        in3: *const futhark_u64_3d,
